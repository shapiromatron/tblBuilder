...
_.extend(AnimalEvidence, {
    ...
    tabular: function(tbl_id) {
        ...
        for (i = 0, len = vals.length; i < len; i++) {
            ...
            row = [v._id, reference.name, reference.pubmedID, v.studyDesign, v.species, v.strain, v.sex, v.agent, v.purity, v.dosingRoute, v.vehicle, v.ageAtStart, v.duration, v.dosingRegimen, strengths, limitations, v.comments];
    ...
    sortFields: {
        'Study design': _.partial(libShared.sortByFieldOrder, studyDesigns, 'studyDesign'),
        'Species':      _.partial(libShared.sortByTextField, 'species'),
        'Strain':       _.partial(libShared.sortByTextField, 'strain'),
        'Sex':          _.partial(libShared.sortByFieldOrder, sexes, 'sex'),
