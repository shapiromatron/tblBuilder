...
_.extend(GenotoxEvidence, {
    ...
    sortFields: {
        "Data class":    "sortDataClass",
        "Agent":         "sortAgent",

        "Phylogenetic class (non-mammalian)":        "sortPhylogeneticClasses",
        "Test system (non-mammalian: acellular)":    "sortTestSystem",
        "Species (non-mammalian: cellular)":         "sortNMSpecies",
        "Strain (non-mammalian: cellular)":          "sortNMStrain",

        "Test species class (mammalian: cellular)":  "sortCMTestSpecies",
        "Species (cellular: mammalian)":             "sortCMSpecies",
        "Tissue (cellular: mammalian)":              "sortCMTissue",

        "Species (animal in-vivo)":   "sortAVSpecies",
        "Strain (animal in-vivo)":    "sortAVStrain",
        "Sex (animal in-vivo)":       "sortAVSex",

        "Tissue (human in-vivo)":     "sortHTissue",
        "Cell type (human in-vivo)":  "sortHCellType",

        "Endpoint":         "sortEndpoint",
        "Endpoint test":    "sortEndpointText",
        "Reference":        "sortReference",
    },
    sortDataClass:              _.partial(libShared.sortByFieldOrder, dataClass, "dataClass"),
    sortAgent:                  _.partial(libShared.sortByTextField, "agent"),
    sortPhylogeneticClasses:    _.partial(libShared.sortByFieldOrder, phylogeneticClasses, "phylogeneticClass"),
    sortTestSystem:     _.partial(libShared.sortByTextField, "testSystem"),
    sortNMSpecies:      _.partial(libShared.sortByTextField, "speciesNonMamm"),
    sortNMStrain:       _.partial(libShared.sortByTextField, "strainNonMamm"),
    sortCMTestSpecies:  _.partial(libShared.sortByFieldOrder, mammalianTestSpecies, "testSpeciesMamm"),
    sortCMSpecies:      _.partial(libShared.sortByTextField, "speciesMamm"),
    sortCMTissue:       _.partial(libShared.sortByTextField, "tissueCellLine"),
    sortAVSpecies:      _.partial(libShared.sortByTextField, "species"),
    sortAVStrain:       _.partial(libShared.sortByTextField, "strain"),
    sortAVSex:          _.partial(libShared.sortByFieldOrder, sexes, "sex"),
    sortHTissue:        _.partial(libShared.sortByTextField, "tissueHuman"),
    sortHCellType:      _.partial(libShared.sortByTextField, "cellType"),
    sortEndpoint:       _.partial(libShared.sortByTextField, "endpoint"),
    sortEndpointText:   _.partial(libShared.sortByTextField, "endpointTest"),
