...
if (Meteor.settings["public"].context === "ntp") {
    extraNTP = {
        printCaption: {
            ...
            type: String,
            optional: true,
            popoverText: "Microsoft Word report table caption name. If left-blank, results will not be printed.",
            typeaheadMethod: "searchPrintCaption",
        },
        printOrder: {
            ...
            decimal: true,
            optional: true,
            popoverText: "Microsoft Word report table order. Rows will be printed in ascending order using this field (decimals allowed). If left-blank or negative, results will not be printed.",
        }
    };
};
...
tblBuilderCollections.attachSchema(EpiResult, _.extend({
    organSite: {
        ...
        type: String,
        min: 1,
        popoverText: "Cancer-organ site for results being measured",
