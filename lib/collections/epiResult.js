...
import { capitalizeFirst } from '/imports/utilities';
...
_.extend(EpiResult, {
    ...
    organSiteCategoryOptions: organSiteCategories.options,
    organSiteCategorySynonyms: organSiteCategories.synonyms,
});
