...
_.extend(ExposureEvidence, {
    ...
    sortFields: {
        ...
        "Agent":                "sortAgent",
        "Exposure scenario":    "sortExposureScenario",
        "Industry/occupation":  "sortIndustry",
        "Country":              "sortCountry",
        "Collection date":      "sortCollectionDate",
        "Sampling approach":    "sortSamplingApproach",
        "Matrix":               "sortMatrix",
    },
    sortReference:  libShared.sortByReference,
    sortExposureScenario:   _.partial(libShared.sortByFieldOrder, exposureScenarios, "exposureScenario"),
    sortIndustry:           _.partial(libShared.sortByTextField, "occupation"),
    sortCountry:            _.partial(libShared.sortByTextField, "country"),
    sortCollectionDate:     _.partial(libShared.sortByTextField, "collectionDate"),
    sortSamplingApproach:   _.partial(libShared.sortByFieldOrder, samplingApproaches, "samplingApproach"),
    sortMatrix:             _.partial(libShared.sortByTextField, "samplingMatrix"),
