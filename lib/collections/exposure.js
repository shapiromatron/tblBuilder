...
_.extend(ExposureEvidence, {
    ...
    tabular: function(tbl_id) {
        ...
        header = ["Exposure ID", "Reference", "Pubmed ID", "Exposure scenario", "Collection date", "Occupation", "Occupational information", "Country", "Location", "Agent", "Sampling Matrix", "Sampling Approach", "Number of measurements", "Measurement duration", "Exposure level", "Exposure level description", "Exposure level range", "Units", "Comments"];
        data = [header];
    ...
    sortFields: {
        ...
        "Exposure scenario":    _.partial(libShared.sortByFieldOrder, exposureScenarios, "exposureScenario"),
        "Industry/occupation":  _.partial(libShared.sortByTextField, "occupation"),
        "Country":              _.partial(libShared.sortByTextField, "country"),
        "Collection date":      _.partial(libShared.sortByTextField, "collectionDate"),
        "Sampling approach":    _.partial(libShared.sortByFieldOrder, samplingApproaches, "samplingApproach"),
        "Matrix":               _.partial(libShared.sortByTextField, "samplingMatrix"),
    },
});
