...
_.extend(EpiDescriptive, {
    ...
    sortFields: {
        ...
        "Exposure assessment method": "sortExposureAssessmentType",

    },
    sortReference:  libShared.sortByReference,
    sortStudyDesign:            _.partial(libShared.sortByTextField, "studyDesign"),
    sortLocation:               _.partial(libShared.sortByTextField, "location"),
    sortExposureAssessmentType: _.partial(libShared.sortByTextField, "exposureAssessmentType"),
});
