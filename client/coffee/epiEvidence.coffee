...
Meteor.startup ->
    ...
    _.extend(epiDescriptiveTblHelpers, clientShared.abstractTblHelpers)
    _.extend(epiDescriptiveTblEvents, clientShared.abstractTblEvents)
    ...
    _.extend(epiDescriptiveRowHelpers, clientShared.abstractRowHelpers)
    ...
    epiDescriptiveFormEvents = $.extend(true, {}, clientShared.abstractFormEvents, epiDescriptiveFormExtension)
    ...
    _.extend(epiResultTblHelpers, clientShared.abstractNestedTableHelpers)
    ...
    getRiskRows = (tmpl, obj) ->
        ...
        for row in $(tbody).find('tr')
            obj.riskEstimates.push(clientShared.newValues(row))
    ...
    epiResultFormEvents = $.extend(true, {}, clientShared.abstractNestedFormEvents, epiResultFormExtension)
    ...
    Template.epiResultForm.rendered = ->
        ...
        if epiResult?
            clientShared.toggleQA(@, epiResult.isQA)
