...
Meteor.startup(function() {
  var animal_endpoint_schema, animal_schema, base_content, epi_descriptive_schema, epi_result_schema, exposure_schema, genotox_schema, isNumberOrNR, mech_schema, ref_schema, reqAcellular, reqAniVivo, reqExpVivo, reqHumanVivo, reqMammVitro, reqNonMamm, reqNotAcellular, requiredCC, requiredCohort, requiredOccupational, tbl_content_base, tbl_schema;
  ...
  requiredCC = function() {
    var isRequired, ref;
    isRequired = (ref = this.field('studyDesign').value, indexOf.call(CaseControlTypes, ref) >= 0) && (this.value === "");
    if (isRequired) {
      return "required";
    }
  };
  ...
  requiredOccupational = function() {
    var isRequired, ref;
    isRequired = (ref = this.field('exposureScenario').value, indexOf.call(exposureScenariosOccupational, ref) >= 0) && (this.value === "");
    if (isRequired) {
      return "required";
    }
  };
