...
class GenotoxTables(DOCXReport):
    ...
    def buildHumanVivoTbl(self):
        ...
        # write title
        txt = 'Table 1 [Genetic and related effects] of [{}] in '\
    ...
    def buildHumanInVitro(self):
        ...
        # write title
        txt = 'Table 2 [Genetic and related effects] of [{}] in '\
    ...
    def buildAniVivoTbl(self):
        ...
        # write title
        txt = 'Table 3 [Genetic and related effects] of [{}] in non-human '\
    ...
    def buildMammInVitroTbl(self):
        ...
        # write title
        txt = 'Table 4 [Genetic and related effects] of [{}] in non-human '\
    ...
    def buildNonMammInVitroTbl(self):
        ...
        # write title
        txt = 'Table 5 [Genetic and related effects] of [{}] in non-mammalian '\
